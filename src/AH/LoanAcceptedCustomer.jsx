...
export default function LoanAcceptedCustomer() {
 ...
 const getAllEnquiry = () => {
    axios.get(`http://localhost:7078/getloan_All_accepted_customer/${'Accept'}`)
  ...
  useEffect(getAllEnquiry, []);
    ...
    {
        axios.get(`http://localhost:7078/loandisbursed/${customerId}`)
...
//   };
  ...
  return (
    <div className="container mt-5">
      <h2 className="text-center mb-4">LOAN ACCEPTED CUSTOMER</h2>
